      ...
      <Layout title="Member">
        <header>
          ...
          <div>
            ...
            <h4> Comment</h4>{/*We need to create an action to allow this button to dropdown the form*/}
              
              <form id="article-form" action={`/private/posts/edit/${post._id}`} method="POST"> {/* We need to create a dropdown post*/}
                  <input type="text" name="title" placeholder="Title"></input>
                  <br/>
                  <input type="text" name="text" placeholder="Write your post"></input>
                  <br/>
